...
var persianDate = function () {
    ...
    return n.prototype = {
        now: function () {
            ...
            for (var i, r, u = new jDateFunctions, e = t > 0 ? t : -t, f = 0; f < e; f++) i = new n, i.month = this.month, i.year = this.year, i = i.addMonth(-1), r = t > 0 ? u.getLastDayOfMonth(this) : u.getLastDayOfMonth(i), t > 0 ? this.date += 1 : this.date -= 1, t > 0 ? this.date > r && (this.date = 1, this.addMonth(1)) : t < 0 && (this.month > 1 && this.date > r ? (this.date = 1, this.addMonth(1)) : this.date == 0 && (this.addMonth(-1), this.date = r));
            return this
        }, addMonth: function (n) {
    ...
    return n.prototype = {
        toPersianNums: function (n) {
            ...
            return res
        }, gregorian_to_jalali: function (n) {
        ...
        }, jalali_to_gregorian: function (n) {
        ...
        }, getLastDayOfMonth: function (n) {
            return (y = n.year, m = n.month, m >= 1 && m <= 6) ? 31 : m >= 7 && m < 12 || this.isLeapYear(y) ? 30 : 29
        }, isLeapYear: function (year) {
            var Result = false;
            year += 621;
            if ((year % 100 == 0 && year % 400 == 0) || (year % 100 != 0 && year % 4 == 0)) Result = true;
            return Result;
        }
    }, n
}()